...
func ListenAndServeWithHttpInstance(server *http.Server) error {
	return NewServer(server.Addr, server.Handler, DEFAULT_READ_TIMEOUT, DEFAULT_WRITE_TIMEOUT).ListenAndServe()
}
